...
const char *AP_SSID     = "ESP32-WIFI_LAB2";      ///< Nombre de la red Wi-Fi (SSID)
const char *AP_PASSWORD = "Zinedine_98";                ///< Contraseña del AP ()
...
void handleRoot() {
  ...
  "function updateUI(j){"
  "upd('led18',j.D18);upd('led19',j.D19);"
...
void setup() {
  ...
  pinMode(PIN_PWM, OUTPUT);  analogWrite(PIN_PWM, 0);
